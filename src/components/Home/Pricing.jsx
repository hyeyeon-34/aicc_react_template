...
const Pricing = () => {
  return (
    <div className=" mt-20">
      <h2 className="text-3xl sm:text-5xl lg:text-6xl text-center my-8 tracking-tight font-customFontKr font-semibold">
        Pricing
      </h2>
        ...
        {pricingOptions.map((option, idx) => (
          <div key={idx} className="p-2 w-full sm:w-1/2 lg:w-1/3">
            <div className="p-10 border border-neutral-700 rounded-lg">
              <p className="text-4xl mb-8 font-customFontEn">
                {option.title}
                {option.title === 'Pro' && (
